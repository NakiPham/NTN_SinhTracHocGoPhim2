...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String c="Tạo bảng "+Database.TABLE_NAME+" ( "+
                Database.b1_x+" TEXT,"+
                Database.b1_y+" TEXT,"+
                Database.b2_x+" TEXT,"+
                Database.b2_y+" TEXT,"+
                ...
                Database.p1_GIU+" TEXT,"+
                Database.p2_GIU+" TEXT,"+
                Database.p3_GIU+" TEXT,"+
                Database.p4_GIU+" TEXT,"+
                Database.p5_GIU+" TEXT,"+
                Database.p6_GIU+" TEXT,"+
                Database.b1_apluc+" TEXT,"+
                Database.b2_apluc+" TEXT,"+
                Database.b3_apluc+" TEXT,"+
                Database.b4_apluc+" TEXT,"+
                Database.b5_apluc+" TEXT,"+
                Database.b6_apluc+" TEXT,"+
                Database.p1_p2_BAY+" TEXT,"+
                Database.p2_p3_BAY+" TEXT,"+
                Database.p3_p4_BAY+" TEXT,"+
                Database.p4_p5_BAY+" TEXT,"+
                Database.p5_p6_BAY+" TEXT,"+
                Database.p1_p2_tgDOI+" TEXT,"+
                Database.p2_p3_tgDOI+" TEXT,"+
                Database.p3_p4_tgDOI+" TEXT,"+
                Database.p4_p5_tgDOI+" TEXT,"+
                Database.p5_p6_tgDOI+" TEXT,"+
                Database.p1_p2_tgBA+" TEXT,"+
                Database.p2_p3_tgBA+" TEXT,"+
                Database.p3_p4_tgBA+" TEXT,"+
                Database.p4_p5_tgBA+" TEXT,"+
                Database.tong_THOIGIAN+" TEXT );";
        db.execSQL(c);

        String cl="Tạo bảng "+Database.BAT_HOP_PHAP_TABLE_NAME+" ( "+
                Database.b1_x+" TEXT,"+
                Database.b1_y+" TEXT,"+
                Database.b2_x+" TEXT,"+
                Database.b2_y+" TEXT,"+
        ...
        String p="Tạo bảng "+Database.PASSWORD_TABLE_NAME+" ( "+
                Database.password + " TEXT );";
        db.execSQL(p);

        String n="Tạo bảng "+DatabaseNetwork.NETWORK_TABLE_NAME+" ( "+
        ...
        String o="Tạo bảng "+DatabaseNetwork.hidden_to_output+" ( "+
        ...
        String training="Tạo bảng "+Database.TRAINING_TABLE_NAME+" ( "+
                Database.TRAINING_STATUS + " TEXT );";
        db.execSQL(training);

        String error="Tạo bảng "+DatabaseNetwork.error_table+" ( "+
                DatabaseNetwork.error1 + " TEXT );";
        //DatabaseNetwork.error2 + " TEXT );";

        db.execSQL(error);
        String target="Tạo bảng "+DatabaseNetwork.target_output_table+" ( "+
